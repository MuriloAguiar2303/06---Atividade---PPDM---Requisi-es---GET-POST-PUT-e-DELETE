  ...
  return (
    <View style={styles.container}>
      ...
      <View  style={{display:'flex', flexDirection:'row',justifyContent:"space-between",width:'100%', height:"24%",padding:10}}>
            ...
            <TouchableOpacity style={{width:"45%",height:"100%",  backgroundColor:"blue", display:'flex', justifyContent:"center",alignItems:"center"}} title='Cadastrar Contato' onPress={navegaHome} ><Text style={{color:"white"}}>Todos Contatos</Text></TouchableOpacity>
